...
import bannerImg from "/images/home/yum.png";
...
Dive into the Delicious World of Culinary Delights <span className="text-green">Food</span>
          </h2>
          <p className="text-[#4A4A4A] text-xl">
          Where Every Dish Tells a Story of Flavor and Passion
          </p>
