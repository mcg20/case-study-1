    ...
    <>
      ...
      <li tabIndex={0}>
        <details>
          ...
          <ul className={`p-2 ${isDarkMode ? 'dark' : ''}`}>
            ...
            <li>
              <Link to="/menu/salad" className={`text-${isDarkMode ? 'dark' : ''}`}>Salad</Link>
            </li>
            <li>
              <Link to="/menu/pizza" className={`text-${isDarkMode ? 'dark' : ''}`}>Pizza</Link>
            </li>
          </ul>
        </details>
      </li>
      <li tabIndex={0}>
        <details>
          ...
          <ul className={`p-2 ${isDarkMode ? 'dark' : ''}`}>
            <li>
              <Link to="/services/online-order" className={`text-${isDarkMode ? 'text-white' : 'black'}`}>Online Order</Link>
            </li>
            <li>
              <Link to="/services/table-booking" className={`text-${isDarkMode ? 'white' : 'black'}`}>Table Booking</Link>
            </li>
            <li>
              <Link to="/services/order-tracking" className={`text-${isDarkMode ? 'white' : 'black'}`}>Order Tracking</Link>
            </li>
          </ul>
        </details>
      </li>
      <li>
        <Link to="/offers" className={`text-${isDarkMode ? 'white' : 'black'}`}>Offers</Link>
      </li>
    </>
  );
